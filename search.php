...
<html>
  <head>
    <?php head($GLOBALS['displayQ'], array(
    "search"
)); ?>
  </head>
  <body>
...
?>
      ...
      <div class="results">
        ...
        foreach ($res['results'] as $re)
        {
            ...
            /*	onmousedown="this.href='<?php echo HOST; ?>url.php?u='+encodeURIComponent(this.getAttribute('data-href'));" data-href="<?php echo $u; ?>"*/
?>
          <div class="result">
...
<img src='<?php echo $pic; ?>' alt='<?php echo $t; ?>'>
            ...
            <h3 class="title">
             <?php echo $s; ?>). <a target="_blank"  href="<?php echo $u; ?>"><?php echo strlen($t) > 59 ? substr($t, 0, 59) . ".." : $t; ?></a>
            </h3>
